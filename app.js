  ...
  "founder": {
    ...
    "name": "Sparrow AI Tech Team"
        ...
        case 'i18n-config':
            ...
            code = generatedFiles['i18n-config'] || `// astro-i18n.config.mjs
export default {
  locales: ["cs", "en"],
  defaultLocale: "cs",
  routes: {
...
function downloadFiles() {
    ...
    alert('Download funkce by vytvořila ZIP soubor se všemi generovanými soubory. Pro demo účely jsou soubory dostupné k kopírování.');
}
