...
describe('MarkdownViewer Component', () => {
  ...
  it('fetches and renders markdown from any path', () => {
    cy.visitApp(`/markdown-test?src=${testMd}`);
  ...
  it('renders Mermaid diagrams', () => {
    cy.visitApp(`/markdown-test?src=${testMermaidMd}`);
  ...
  it('shows loading and error states', () => {
    ...
    cy.visitApp(`/markdown-test?src=${notFoundMd}`);
  ...
  it('applies custom className', () => {
    ...
    cy.visitApp(`/markdown-test?src=${testMd}&className=custom-md-class`);
    cy.get('.markdown-viewer').should('have.class', 'custom-md-class');
  });

  it('renders markdown content', () => {
    cy.visitApp('/markdown-test?src=./articles/mcp-prompts.md');
    cy.get('.prose').should('exist');
    cy.contains('Some expected heading or text from the markdown');
  });

  it('renders mermaid diagram', () => {
    cy.visitApp('/markdown-test?src=./articles/mermaid-example.md');
  ...
  it('shows error on fetch fail', () => {
    ...
    cy.visitApp('/markdown-test?src=./articles/does-not-exist.md');
  ...
  it('shows Mermaid diagram preview on hover for .mmd links', () => {
    ...
    cy.visitApp('/markdown-test?src=./articles/mermaid-test-link.md');
  ...
  it('shows GitHub repo metadata tooltip on hover for repo links', () => {
    ...
    cy.visitApp('/markdown-test?src=./articles/github-link-test.md');
