    ...
    <div className="container mx-auto px-6">
      <h1
        ...
        dangerouslySetInnerHTML={{
          __html: translations.hero_title_html || 'Welcome to Sparrow AI Tech',
        }}
      />
...
const AboutSection = ({ translations }) => {
  const benefits = [
    {
      title: translations.about_benefit1_title || 'AI Integration',
      description: 'Advanced AI tools',
    },
    {
      title: translations.about_benefit2_title || 'Interactive Design',
      description: 'Engaging user experience',
    },
    {
      title: translations.about_benefit3_title || 'Modern Stack',
  ...
  return (
    <div className="bg-white text-stone-800 dark:bg-slate-900 dark:text-stone-100">
      ...
      <section className="bg-gray-50 py-16 dark:bg-slate-800">
        <div className="container mx-auto px-6 text-center">
          <h2 className="mb-8 text-2xl font-bold">Current Language: {language}</h2>
