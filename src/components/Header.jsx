...
const Header = () => {
  ...
  return (
    <nav className="header-nav" data-cy="header-nav">
      <ul>
        <li><a href="#hero" data-cy="nav-hero">{t('header.nav_hero')}</a></li>
        <li><a href="#services" data-cy="nav-services">{t('header.nav_services')}</a></li>
        <li><a href="#articles" data-cy="nav-articles">{t('header.nav_articles')}</a></li>
